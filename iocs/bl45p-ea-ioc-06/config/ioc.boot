...
#
#save_restoreSet_status_prefix "BL45P-EA-IOC-06"
#save_restoreSet_Debug 0
#save_restoreSet_NumSeqFiles 3
#save_restoreSet_SeqPeriodInSeconds 600
#save_restoreSet_DatedBackupFiles 1
#save_restoreSet_IncompleteSetsOk 1
#set_pass0_restoreFile "BL45P-EA-IOC-06_0.sav"
#set_pass0_restoreFile "BL45P-EA-IOC-06_1.sav"
#set_pass1_restoreFile "BL45P-EA-IOC-06_1.sav"
#set_pass1_restoreFile "BL45P-EA-IOC-06_2.sav"


# simDetectorConfig(portName, maxSizeX, maxSizeY, dataType, maxBuffers, maxMemory)
simDetectorConfig("AND.cam", 4128, 4104, 1, 50, 0)

# SimHDF5DetectorConfig(portName, maxBuffers, maxMemory )
SimHDF5DetectorConfig(AND.hdf, 0,         0 )
...
dbLoadRecords (simHDF5Detector.template, "P=BL45P-EA-AND-01, R=:HDF:, PORT=AND.hdf, TIMEOUT=1, ADDR=0")
...
dbLoadRecords(iocAdminSoft.db, "IOC=BL45P-EA-IOC-06")
dbLoadRecords(iocAdminScanMon.db, "IOC=BL45P-EA-IOC-06")
# dbLoadRecords(iocGui.db, "name=DEV, EDM_FILE=ioc_stats_softdls.edl, IOC=BL45P-EA-IOC-06")

# Final ioc initialisation
# ------------------------
iocInit

# create_monitor_set "BL45P-EA-IOC-06_0.req",  5, ""
# create_monitor_set "BL45P-EA-IOC-06_1.req", 30, ""
# create_monitor_set "BL45P-EA-IOC-06_2.req", 30, ""
