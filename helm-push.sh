...
#  CR_TOKEN: the password for the registry
#  DO_PUSH: if set to true, the chart will be pushed to the registry (default: false)
...
login() {
    ...
    echo ${CR_TOKEN} | helm registry login -u ${CR_USER} --password-stdin http://${REGISTRY_FOLDER}
}
